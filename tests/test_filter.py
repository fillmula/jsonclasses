...
class TestFilter(TestCase):
    ...
    # def test_filter_does_not_raise_if_it_filters_tuple(self):
    #     item = SuperFilter(t_fil=(1, 3, 5, 13))
    #     self.assertEqual(item.t_fil, tuple(filter(lambda a:a%2, (0, 1, 2, 3, 5, 8, 13))))
