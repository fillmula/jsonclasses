...
class TestTobomon(TestCase):
    ...
    def test_tobomon_transforms_datetime_into_the_time_of_the_beginning_of_month(self):
        d = SuperDateTime(dtbmth=datetime(2021, 10, 11, 17, 37, 27,43235))
        self.assertEqual(d.dtbmth, datetime(2021,10, 1, 0, 0))

    def test_tobomon_transforms_date_into_the_time_of_the_beginning_of_month(self):
