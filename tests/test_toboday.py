...
class TestToboday(TestCase):
    ...
    def test_toboday_transforms_datetime_into_the_time_of_the_beginning_of_the_day(self):
        d = SuperDateTime(dtbd=datetime(2021, 10, 11, 17, 37, 27,43235))
        self.assertEqual(d.dtbd, datetime(2021,10, 11, 0, 0))

    def test_toboday_transforms_date_into_the_time_of_the_beginning_of_the_day(self):
